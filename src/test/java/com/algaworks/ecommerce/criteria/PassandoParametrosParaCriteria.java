...
public class PassandoParametrosParaCriteria extends EntityManagerTest {
    ...
    public void passarParametroDate(){
        ...
        criteriaQuery.where(criteriaBuilder.greaterThan(root.get("id"), parameterExpressionDate));
        ...
        NotaFiscal pedido = typedQuery.getSingleResult();
